...
config :jira_dashboard,
  ecto_repos: [JiraDashboard.Repo],
  generators: [binary_id: true]

# Configures the endpoint
config :jira_dashboard, JiraDashboardWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: JiraDashboardWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :jira_dashboard, JiraDashboard.Mailer, adapter: Swoosh.Adapters.Local
